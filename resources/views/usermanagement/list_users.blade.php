                    ...
                    <div class="card-body">
                        <div class="page-header">
                            <div class="row align-items-center">
                                    ...
                                    <a href="{{ route('user/add/page') }}" class="btn btn-primary">
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a class="avatar avatar-sm me-2">
                                                    <img class="avatar-img rounded-circle img-fluid"src="{{ Storage::url('student-photos/'.$list->avatar) }}"alt="{{ $list->name }}">
                                                </a>
                                            </h2>
                                        </td>
                                        <td>{{ $list->name }}</td>
                                        ...
                                        <td class="text-end">
                                            <div class="actions">
                                                @if ($list->role_name === 'Orang Tua Murid')
                                                @else
