                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select" name="role_name">
                                                ...
                                                <option value="Guru TK A" {{ $users->role_name == 'Guru TK A' ? 'selected' : '' }}>Guru TK A</option>
                                                <option value="Guru TK B" {{ $users->role_name == 'Guru TK B' ? 'selected' : '' }}>Guru TK B</option>
                                                <option value="Kepala Sekolah" {{ $users->role_name == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala Sekolah</option>
                                                <option value="Orang Tua Murid" {{ $users->role_name == 'Orang Tua Murid' ? 'selected' : '' }}>Orang Tua Murid</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <div class="user-img mt-3">
                                                ...
                                                <img class="rounded-circle" src="{{ Storage::url('student-photos/'. $users->avatar) }}">
                                            <input type="file" class="form-control ms-2" name="avatar" value="{{ $users->avatar }}">
                                        </div>
                                        </div>
