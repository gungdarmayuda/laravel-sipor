                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ms-md-n2 profile-user-info">
                            ...
                            <div class="user-Location"><i class="fas fa-map-marker-alt"></i> {{ Session::get('role_name') }}</div>
                        </div>
                            ...
                            <div class="col-lg-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <p class="col-sm-3 text-muted text-sm-end mb-0">Akun Dibuat</p>
                                            <p class="col-sm-9 mb-0">{{ Session::get('join_date') }}<br>
                                        </div>
                                    </div>
                                </div>
                            </div>
