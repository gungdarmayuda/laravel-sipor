    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="student-group-form">
                <form action="{{ route('studentrapor/list') }}">
                <div class="row">
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('studentrapor/list') }}" class="btn btn-outline-gray me-1 active"><i class="feather-list"></i></a>
                                        <a href="{{ route('studentrapor/grid') }}" class="btn btn-outline-gray me-1"><i class="feather-grid"></i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                    <thead class="student-thread">
                                        <tr>
                                            ...
                                            <th class="text-end">Isi Data Ketidakhadiran</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="">{{ $list->nm_anak }}</a>
                                                </h2>
                                            </td>
                                            <td>{{ $list->rapor->sakit }}</td>
                                            <td>{{ $list->rapor->ijin }}</td>
                                            <td>{{ $list->rapor->tanpa_ket }}</td>
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="{{ url('studentrapor/edit/'.$list->id) }}" class="btn btn-sm bg-danger-light">
