                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('nstk') is-invalid @enderror" name="nstk" placeholder="Enter NSTK" value="{{ old('nstk') }}">
                                            @error('nstk')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('npsn') is-invalid @enderror" name="npsn" placeholder="Enter NPSN" value="{{ old('npsn') }}">
                                            @error('npsn')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('nohp_ayah') is-invalid @enderror" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" name="nohp_ayah" placeholder="Enter No.HP Ayah/Wali" value="{{ old('nohp_ayah') }}">
                                            @error('nohp_ayah')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('nohp_ibu') is-invalid @enderror" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" name="nohp_ibu" placeholder="Enter No.HP Ibu/Wali" value="{{ old('nohp_ibu') }}">
                                            @error('nohp_ibu')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
