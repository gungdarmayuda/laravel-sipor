        ...
        <tr class="center7 border">
            ...
            <td class="center7 border" colspan="3" rowspan="3">
                 @if ($data->pengesahan->pengesahan_orangtua === '0')
                    ...
                    <br>
                @else
                    <img src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->merge(public_path('logo.png'),0.2, true)->errorCorrection('Q')->size(200)->generate('http://newprojectsipor-laravel.test/qr/murid/'.$data->nm_anak) ) }}"/>
                @endif
            </td>
        </tr>
         </tr>
