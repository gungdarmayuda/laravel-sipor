@if($studentList->count())
                            ...
                            <div class="center">
                                ...
                                <div class="center4">
                                    <table class="center5">
                                        <tr>
                                           <td>Denpasar, {{ $data->tgl_lahir }} <br>Kepala TK Dharmapatni Denpasar</td>
                                        </tr>
                                        <tr>
                                            <img src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->merge(public_path('logo.png'),0.2, true)->errorCorrection('H')->size(200)->generate('http://newprojectsipor-laravel.test/qr/murid/'.$data->nm_anak) ) }}"/>
                                        </tr>
                                        {{-- <tr>
                                            <br>
                                            <br>
                                    ...
                                    <tr class="center7">
                                       ...
                                       <td class="center7" colspan="2">
                                            @if ($data->kelas->kelas_type === 'A')
                                                <h5 class="tipis">Denpasar, {{ $data->tgl_lahir }} <br>Guru Kelompok A</h5>
                                            @else
                                                <h5 class="tipis">Denpasar, {{ $data->tgl_lahir }} <br>Guru Kelompok B</h5>
                                            @endif
                                       </td>
                                    </tr>
                                    <tr class="center7">
                                        <td class="center7" colspan="2">
                                                {{-- @if ($data->pengesahan->kepala_sekolah === '0')
                                                <br>
                                                <br>
                                                <br>
                                                <br>
