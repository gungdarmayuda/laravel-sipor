                    ...
                    <div class="profile-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto profile-btn">
                                <a href="{{ url('studentlihat/rapor/'.$data->no_induk.'-'.$data->nm_anak) }}" class="btn btn-primary">Lihat Rapor</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <p class="col-sm-3 text-muted text-sm-end mb-0">Status Rapor
                                                <div class="edit-delete-btn col-sm-3 text-muted">
                                                    @if ($data->pengesahan->pengesahan_orangtua === '0')
                                                    <a class="text-danger" >Belum Terkonfirmasi</a>
                                                    @else 
                                        ...
                                        <div class="row mb-3">
                                            <p class="col-sm-3 text-muted text-sm-end mb-0"></p>
                                            <p class="col-sm-9 mb-0"><span class="login-danger">*</span>Status Rapor akan berubah setelah melakukan pengesahan oleh orang tua murid<br></p>
                                        </div>
                                        <div class="row mb-3">
                                            <p class="col-sm-3 text-muted text-sm-end mb-0"></p>
                                            <p class="col-sm-9 mb-0"><span class="login-danger">*</span>Orang tua murid tidak perlu mencetak rapor<br></p>
                                        </div>
                            </div>
                        </div>
                    </div>
