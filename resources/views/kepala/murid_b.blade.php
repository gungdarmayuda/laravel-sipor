    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="student-group-form">
                <form action="{{ route('studentmurid/tk_b') }}">
                <div class="row">
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('studentmurid/tk_b') }}" class="btn btn-outline-gray me-1 active"><i class="feather-list"></i></a>
                                        <a href="{{ route('studentmurid/grid_b') }}" class="btn btn-outline-gray me-1"><i class="feather-grid"></i></a>
                                    </div>
                                </div>
                            </div>
